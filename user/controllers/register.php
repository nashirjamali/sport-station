              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="email" aria-describedby="emailHelp" placeholder="Email">
                    </div>
                    <div class="form-group">
                    ...
                    <form class="user">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="nohp" placeholder="No Handphone">
                    </div>
                    <form class="user">
                    <div class="form-group">
                    ...
                    <a href="login.php" class="btn btn-facebook btn-user btn-block">
                      <i class="fab fa-facebook-f fa-fw"></i> Back To Login Page
                    </a>
                  </form>
                  <hr>
                  <div class="text-center">
